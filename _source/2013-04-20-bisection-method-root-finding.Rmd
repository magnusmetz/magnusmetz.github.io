...
`bisection.method()` is applied to show you one of the numercical root-finding methods -- the
[Bisection Method](http://en.wikipedia.org/wiki/Root-finding_algorithm#Bisection_Method).
